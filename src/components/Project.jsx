...
const Project = (props) => {
    ...
    return (
        <>
            ...
            <div className="project-part2 p-3 md:p-6 lg:py-2 xl:py-10 h-[50%] sm:h-full w-full sm:w-[55%] bg-gray-900 rounded-b-lg sm:rounded-b-none sm:rounded-r-lg flex flex-col justify-start items-start gap-3 md:gap-4 text-white">
                ...
                <a href={myProject.vc_link} target="_blank" className="sm:px-3 sm:py-2 px-2 py-1 bg-indigo-300 text-black text-lg font-semibold rounded-sm flex gap-3 justify-center items-center">View Code</a>
            </div>
        </>
    );
